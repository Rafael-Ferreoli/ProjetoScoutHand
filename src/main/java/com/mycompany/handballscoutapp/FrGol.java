 ...
 * @author ifmaker
 */
public class FrGol extends javax.swing.JFrame {

    private String quadranteGol;
    private List<String> informacoesGols = new ArrayList<>();
    private boolean acaoExecutada = false;
    private String quadranteChuteFinal;
    

    public FrGol(String quadranteChute) {
        this.quadranteGol = quadranteGol;
